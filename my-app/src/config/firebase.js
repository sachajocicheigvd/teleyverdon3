...
import {getAuth,GoogleAuthProvider} from "firebase/auth"; //pour importer les fonctionnalité de l'authentification
...
export const googleProvider = new GoogleAuthProvider(); //pour l'authentification avec google
